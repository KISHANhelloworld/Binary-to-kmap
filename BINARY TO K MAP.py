def minFunc(numVar, stringIn): # numvar is number of variables , and stringIn has to give dont care in d('') else put d-.
	num= int(numVar)
	x= stringIn
	"""
	...
	for i in range(len(l)):
			for j in range(num):				#Storing the digit speratly on the basis of how many 1's they contain
				if(l[i][j]=='1'):
					count+=1
			if(count==0):
				a.append(l[i])
...
#print(minFunc('2','(1,2)d-'))   # f0r 2 variable
print(minFunc('3','(5,6,7)d-'))    # number of var =3 ,find for number =224 =bin(11100000)-->> input =(positions of 1 that is 5,6,7 )
#print(minFunc('3','(2,5)d(0,4,6)'))
#print(minFunc('4','(3,9,12,15)d(0,1,4,7,8,10,11,14)')) # for 4 var.
